...
// Included from C:\Users\ianli\Desktop\CP\template\Graph\Misc\Graph.cpp
// 0 based
class Graph {
	private:
		vector<int> *_graph;
...
Graph::Graph() : _graph(nullptr), _size(0), _edge_count(0) {}
Graph::Graph(int n) : _graph(new vector<int>[n]), _size(n), _edge_count(0) {}
Graph::~Graph() {delete [] _graph;}

int Graph::edge_count() const {return _edge_count;}
int Graph::size() const {return _size;}
void Graph::init(int n) {
	clear();
	_graph = new vector<int>[_size = n];
	return ;
}
...
// End of C:\Users\ianli\Desktop\CP\template\Graph\Misc\Graph.cpp
