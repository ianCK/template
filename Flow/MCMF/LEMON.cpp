/* Usage :
 * mcf_graph_ns<Capacity, Weight> mcmf(node_count) (0 indexed)
 * mcmf.add_edge(from, to, lower_cap, upper_cap, wei)
 *
 * mcmf.set_supply(S, some proper value)
 * mcmf.set_supply(T, some proper value)
 *
 * mcmf.solve() -> return value
 *
 * --- to get the edges ---
