template <typename T, T (*op)(const T&, const T&), T E, T (*inv)(const T&)> constexpr Group<T, op, E, inv> Group<T, op, E, inv>::operator / (const Group<T, op, E, inv>& o) const { return Group<T, op, E, inv>(op(Monoid<T, op, E>::val, o.inverse())); }
